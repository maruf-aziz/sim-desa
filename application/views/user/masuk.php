	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="block">
					<!-- Image -->
					<div class="image align-self-center"><img class="img-fluid" src="<?= base_url('assets/frontend/') ?>images/Login/front-desk-sign-in.jpg"
							alt="desk-image"></div>
					<!-- Content -->
					<div class="content text-center">
						...
						<div class="title-text">
							<h2><strong>Masuk Ke Akun Anda</strong></h2>
						</div>
						<form action="#">
							<!-- Username -->
						...
						<div class="new-acount">
							<p>Belum Memiliki Akun? <a href="<?= base_url() ?>user/daftar"> Daftar </a></p>
						</div>
					</div>
				</div>
			</div>
