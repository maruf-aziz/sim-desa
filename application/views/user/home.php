        ...
        <li class="nav-item dropdown active">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown dropdown-submenu dropright">
              <a class="dropdown-item dropdown-toggle" href="<?=base_url('assets/frontend/')?>#!" id="dropdown0301" role="button"
        ...
        <li class="nav-item dropdown @@pages">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown dropdown-submenu dropleft">
              <a class="dropdown-item dropdown-toggle" href="<?=base_url('assets/frontend/')?>#!" id="dropdown0501" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sub Menu</a>
		...
		<div class="row align-items-center">
			<div class="col-md-6 order-2 order-md-1 text-center text-md-left">
				...
				<p class="text-white mb-5">Besides its beautiful design. Laapp is an incredibly rich core framework for you to
					showcase your App.</p>
				<a href="<?=base_url('assets/frontend/')?>FAQ.html" class="btn btn-main-md">Download Now</a>
			</div>
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="<?=base_url('assets/frontend/')?>images/mobile.png" alt="screenshot">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="<?=base_url('assets/frontend/')?>images/feature/feature-new-01.jpg" alt="iphone">
				</div>
			</div>
			<div class="col-lg-6 mr-auto align-self-center">
				<div class="feature-content">
					...
					<h2>Increase your productivity with <a
							href="<?=base_url('assets/frontend/')?>https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a></h2>
					<!-- Feature Description -->
				...
				<div class="testimonial">
					...
					<ul class="list-inline meta">
						<li class="list-inline-item">
							<img src="<?=base_url('assets/frontend/')?>images/testimonial/feature-testimonial-thumb.jpg" alt="">
						</li>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="<?=base_url('assets/frontend/')?>images/feature/feature-new-02.jpg" alt="ipad">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title">
					...
					<p><a href="<?=base_url('assets/frontend/')?>https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a> makes
		...
		<div class="row no-gutters">
			<div class="col-lg-6 align-self-center">
				...
				<div class="service-thumb left" data-aos="fade-right">
					<img class="img-fluid" src="<?=base_url('assets/frontend/')?>images/feature/iphone-ipad.jpg" alt="iphone-ipad">
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="content-block">
					...
					<!-- Popup Video -->
					<a data-fancybox href="<?=base_url('assets/frontend/')?>https://www.youtube.com/watch?v=jrkvirglgaQ">
				...
				<div class="testimonial-slider owl-carousel owl-theme">
					...
					<div class="item">
						<div class="block shadow">
							...
							<!-- Person Thumb -->
							<div class="image">
								<img src="<?=base_url('assets/frontend/')?>images/testimonial/feature-testimonial-thumb.jpg" alt="image">
							</div>
							<!-- Name and Company -->
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<p>Download over 2 million humans .Get <a href="<?=base_url('assets/frontend/')?>https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a> free forever!
					<br>We say you won’t look back.</p>
				<ul class="list-inline">
					<li class="list-inline-item">
						<a href="<?=base_url('assets/frontend/')?>" class="btn btn-rounded-icon">
							<i class="ti-apple"></i>
							Iphone
						</a>
					</li>
...
<footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
          <div class="block">
            <a href="<?=base_url('assets/frontend/')?>index.html"><img src="<?=base_url('assets/frontend/')?>images/logo-alt.png" alt="footer-logo"></a>
            <!-- Social Site Icons -->
            <ul class="social-icon list-inline">
              <li class="list-inline-item">
                <a href="<?=base_url('assets/frontend/')?>https://www.facebook.com/themefisher"><i class="ti-facebook"></i></a>
              </li>
              <li class="list-inline-item">
                <a href="<?=base_url('assets/frontend/')?>https://twitter.com/themefisher"><i class="ti-twitter"></i></a>
              </li>
              <li class="list-inline-item">
                <a href="<?=base_url('assets/frontend/')?>https://www.instagram.com/themefisher/"><i class="ti-instagram"></i></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
          <div class="block-2">
            ...
            <!-- links -->
            <ul>
              <li><a href="<?=base_url('assets/frontend/')?>team.html">Teams</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>blog.html">Blogs</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>FAQ.html">FAQs</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
          <div class="block-2">
            ...
            <!-- links -->
            <ul>
              <li><a href="<?=base_url('assets/frontend/')?>sign-up.html">Singup</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>sign-in.html">Login</a></li>
        ...
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
          <div class="block-2">
            ...
            <!-- links -->
            <ul>
              <li><a href="<?=base_url('assets/frontend/')?>career.html">Career</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>contact.html">Contact</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>team.html">Investor</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>privacy.html">Terms</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-6 mt-5 mt-lg-0">
          <div class="block-2">
            ...
            <!-- links -->
            <ul>
              <li><a href="<?=base_url('assets/frontend/')?>about.html">About</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>contact.html">Contact</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>team.html">Team</a></li>
              <li><a href="<?=base_url('assets/frontend/')?>privacy-policy.html">Privacy Policy</a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="text-center bg-dark py-4">
    <small class="text-secondary">Copyright &copy; <script>document.write(new Date().getFullYear())</script>. Designed &amp; Developed by <a href="<?=base_url('assets/frontend/')?>https://themefisher.com/">Themefisher</a></small class="text-secondary">
  </div>

	<div class="text-center bg-dark py-1">
   <small> <p>Distributed By <a href="<?=base_url('assets/frontend/')?>https://themewagon.com/">Themewagon</a></p></small class="text-secondary">
  </div>
</footer>
  ...
  <script src="<?=base_url('assets/frontend/')?>plugins/fancybox/jquery.fancybox.min.js"></script>
  <script src="<?=base_url('assets/frontend/')?>plugins/syotimer/jquery.syotimer.min.js"></script>
  <script src="<?=base_url('assets/frontend/')?>plugins/aos/aos.js"></script>
  <!-- google map -->
  <script src="<?=base_url('assets/frontend/')?>https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
