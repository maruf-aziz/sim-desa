...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <span class="nav-link" href="<?=base_url('assets/backend/')?>#">
          ...
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="<?=base_url('assets/backend/')?>#" data-toggle="dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list" aria-labelledby="notificationDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="<?=base_url('assets/backend/')?>assets/images/faces/face4.jpg" alt="" class="profile-pic" />
                    </div>
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="<?=base_url('assets/backend/')?>assets/images/faces/face3.jpg" alt="" class="profile-pic" />
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="<?=base_url('assets/backend/')?>assets/images/faces/face2.jpg" alt="" class="profile-pic" />
                    </div>
                    <div class="preview-item-content">
              ...
              <li class="nav-item dropdown d-none d-sm-flex">
                <a class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="<?=base_url('assets/backend/')?>#" data-toggle="dropdown">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              <li class="nav-item dropdown d-none d-xl-flex border-0">
                <a class="nav-link dropdown-toggle" id="languageDropdown" href="<?=base_url('assets/backend/')?>#" data-toggle="dropdown">
                  <i class="mdi mdi-earth"></i> English </a>
                <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
                  <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#"> French </a>
                  <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#"> Spain </a>
                  <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#"> Latin </a>
                  <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#"> Japanese </a>
                </div>
              </li>
        ...
        <div class="main-panel">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-7">
                        ...
                        <p class="text-muted"> Show overview jan 2018 - Dec 2019 <a class="text-muted font-weight-medium pl-2" href="<?=base_url('assets/backend/')?>#"><u>See Details</u></a>
                        </p>
                      </div>
              ...
              <div class="col-xl-8 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body px-0 overflow-auto">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<?=base_url('assets/backend/')?>assets/images/faces/face10.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<?=base_url('assets/backend/')?>assets/images/faces/face11.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<?=base_url('assets/backend/')?>assets/images/faces/face13.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<?=base_url('assets/backend/')?>assets/images/faces/face16.jpg" alt="image" />
                                <div class="table-user-name ml-3">
                    ...
                    <a class="text-black mt-3 d-block pl-4" href="<?=base_url('assets/backend/')?>#">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                      <img class="survey-img mb-lg-3" src="<?=base_url('assets/backend/')?>assets/images/dashboard/img_3.jpg" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="<?=base_url('assets/backend/')?>assets/images/dashboard/img_1.jpg" alt="" />
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="<?=base_url('assets/backend/')?>assets/images/dashboard/img_2.jpg" alt="" />
                      <div class="pt-2">
                    ...
                    <a class="text-black mt-3 d-block font-weight-medium h6" href="<?=base_url('assets/backend/')?>#">View all <i class="mdi mdi-chevron-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="<?=base_url('assets/backend/')?>assets/images/faces/face22.jpg" alt="" />
                          </div>
                      ...
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<?=base_url('assets/backend/')?>assets/images/faces/face25.jpg" alt="" />
                          </div>
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<?=base_url('assets/backend/')?>assets/images/faces/face15.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<?=base_url('assets/backend/')?>assets/images/faces/face5.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<?=base_url('assets/backend/')?>assets/images/faces/face2.jpg" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="<?=base_url('assets/backend/')?>assets/images/dashboard/img_4.jpg" alt="" />
                          <div class="pl-2">
                    ...
                    <div class="row py-3 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="<?=base_url('assets/backend/')?>assets/images/dashboard/img_5.jpg" alt="" />
                          <div class="pl-2">
              ...
              <div class="col-xl-4 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <span class="d-flex justify-content-between">
                        ...
                        <span class="dropdown dropleft d-block">
                          ...
                          <span class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#">Contact</a>
                            <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#">Helpdesk</a>
                            <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#">Chat with us</a>
                          </span>
                        </span>
                      </span>
                    </h4>
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="<?=base_url('assets/backend/')?>assets/images/faces/face1.jpg" alt="" />
                              <img class="ml-1" src="<?=base_url('assets/backend/')?>assets/images/faces/face10.jpg" alt="" />
                              <img class="ml-1" src="<?=base_url('assets/backend/')?>assets/images/faces/face14.jpg" alt="" />
                            </span>
                          </span>
                        </p>
                      </li>
                    ...
                    <a class="text-black mt-3 mb-0 d-block h6" href="<?=base_url('assets/backend/')?>#">View all <i class="mdi mdi-chevron-right"></i></a>
                  </div>
                </div>
                <!--activity ends-->
              </div>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="<?=base_url('assets/backend/')?>assets/images/faces/face2.jpg" alt="" />
                            </div>
                          ...
                          <div class="d-flex pt-1 align-items-center">
                            ...
                            <div class="dropdown dropleft pl-1 pt-3">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#">Sales</a>
                                <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#">Track Invoice</a>
                                <a class="dropdown-item" href="<?=base_url('assets/backend/')?>#">Payment History</a>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="<?=base_url('assets/backend/')?>assets/images/faces/face3.jpg" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="<?=base_url('assets/backend/')?>assets/images/faces/face11.jpg" alt="" />
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<?=base_url('assets/backend/')?>assets/images/browser-logo/opera-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<?=base_url('assets/backend/')?>assets/images/browser-logo/safari-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<?=base_url('assets/backend/')?>assets/images/browser-logo/chrome-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<?=base_url('assets/backend/')?>assets/images/browser-logo/firefox-logo.png" alt="" />
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          <div>
                            <img class="mr-2" src="<?=base_url('assets/backend/')?>assets/images/browser-logo/explorer-logo.png" alt="" />
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="<?=base_url('assets/backend/')?>https://www.bootstrapdash.com/" target="_blank">Bootstrap dashboard template</a> from Bootstrapdash.com</span>
            </div>
          </footer>
        </div>
        <!-- main-panel ends -->
    ...
    <script src="<?=base_url('assets/backend/')?>assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    <script src="<?=base_url('assets/backend/')?>assets/vendors/flot/jquery.flot.js"></script>
    <script src="<?=base_url('assets/backend/')?>assets/vendors/flot/jquery.flot.resize.js"></script>
    <script src="<?=base_url('assets/backend/')?>assets/vendors/flot/jquery.flot.categories.js"></script>
    <script src="<?=base_url('assets/backend/')?>assets/vendors/flot/jquery.flot.fillbetween.js"></script>
    <script src="<?=base_url('assets/backend/')?>assets/vendors/flot/jquery.flot.stack.js"></script>
    <script src="<?=base_url('assets/backend/')?>assets/vendors/flot/jquery.flot.pie.js"></script>
